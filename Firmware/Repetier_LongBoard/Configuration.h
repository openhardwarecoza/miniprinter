...
#define XAXIS_STEPS_PER_MM 50
/** \brief Number of steps for a 1mm move in y direction.
For xy gantry use 2*belt moved!
Overridden if EEPROM activated.*/
#define YAXIS_STEPS_PER_MM 50
...
#define EXT0_STEPS_PER_MM 101 //385
...
#define X_MAX_LENGTH 106
#define Y_MAX_LENGTH 98
...
/** Maximum feedrate, the system allows. Higher feedrates are reduced to these values.
    The axis order in all axis related arrays is X, Y, Z
     Overridden if EEPROM activated.
    */
#define MAX_FEEDRATE_X 5000
#define MAX_FEEDRATE_Y 5000
#define MAX_FEEDRATE_Z 5000
...
*/
#define EEPROM_MODE 0 // Rev 5 = new Z Jerk value
...
#define UI_PRINTER_NAME "MiniBot"
#define UI_PRINTER_COMPANY "Openhardware.co.za"
...
*/
#define BEEPER_SHORT_SEQUENCE 1,7
