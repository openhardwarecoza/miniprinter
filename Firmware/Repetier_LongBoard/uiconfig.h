...
#define UI_DISPLAY_D2_PIN _BV(-1)
...
//  UI_KEYS_INIT_BUTTON_LOW(42);
  ...
  UI_KEYS_INIT_CLICKENCODER_LOW(11,10); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.1
  UI_KEYS_INIT_BUTTON_LOW(12); // push button, connects gnd to pin
...
// UI_KEYS_INIT_CLICKENCODER_LOW(10,11); // OpenHardware.co.za Encoder
// UI_KEYS_INIT_BUTTON_LOW(12); // push button, connects gnd to pin OpenHardware.co.za Encoder
//
...
//  UI_KEYS_CLICKENCODER_LOW_REV(11,10); // click encoder on pins 47 and 45. Phase is connected with gnd for signals.
//  UI_KEYS_BUTTON_LOW(12,UI_ACTION_OK); // push button, connects gnd to pin
#endif
}
...
//    UI_KEYS_I2C_CLICKENCODER_LOW_REV(_BV(2),_BV(0)); // click encoder on pins 0 and 2. Phase is connected with gnd for signals.
//    UI_KEYS_I2C_BUTTON_LOW(_BV(0),UI_ACTION_OK); // push button, connects gnd to pin
//    UI_KEYS_I2C_BUTTON_LOW(_BV(1),UI_ACTION_BACK); // push button, connects gnd to pin
//    UI_KEYS_I2C_BUTTON_LOW(_BV(2),UI_ACTION_MENU_QUICKSETTINGS+UI_ACTION_TOPMENU); // push button, connects gnd to pin
//    UI_KEYS_I2C_BUTTON_LOW(_BV(3),UI_ACTION_MENU_EXTRUDER+UI_ACTION_TOPMENU); // push button, connects gnd to pin
//    UI_KEYS_I2C_BUTTON_LOW(_BV(4),UI_ACTION_MENU_POSITIONS+UI_ACTION_TOPMENU); // push button, connects gnd to pin
  ...
  // Button handling for the Adafruit RGB shild
    ...
    UI_KEYS_I2C_BUTTON_LOW(_BV(1),UI_ACTION_BACK); // left button
    UI_KEYS_I2C_BUTTON_LOW(_BV(4),UI_ACTION_OK); // right button
    UI_KEYS_I2C_BUTTON_LOW(_BV(0),UI_ACTION_MENU_QUICKSETTINGS);  //Select button
  // ----- End RGB shield ----------
